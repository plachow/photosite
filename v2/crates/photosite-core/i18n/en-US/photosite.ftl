...
command-editor-actual = One pixel per point (100 %)
command-editor-fit = Fit the whole photograph
command-editor-zoom-in = Look closer
command-editor-zoom-out = Step back
tab-manager = Manager
